...
const formValidations = {
  email: [ (value) => value.includes('@'), 'El correo debe tener formato correcto.' ],
  password: [ (value) => value.length >= 6, 'El password deber tener más de 6 caracteres.' ],
